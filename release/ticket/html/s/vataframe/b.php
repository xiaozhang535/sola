...
<head>
    ...
    <script type="text/javascript">
        //document.domain = "qunar.com"; //gino
        document.domain = "10.211.55.5";
        var Current_ad_id = location.hash.replace(/^#/,'');
        var top = parent, call_show = 0 , pAD = parent.QNR.AD;
        var writeContent = pAD.writeContent , \$inject_flash = pAD.\$inject_flash;
