...
function LoadImg(bg, msg) {//加载数据提示框
    ...
    var centerhtml = "<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td align='right' width='40' style='padding-top:15px; padding-right:6px;'><img src='/Images/loading.gif' alt='' /></td><td  style='padding-top:16px;'>" + msg + "<b>, </b>请稍候<b>...</b></td></tr></table>";
...
strPopHtm += "<div onclick='objPopDiv.isclose=true;objPopDiv.close()' class='icodiv ico11' style='float:right; margin-right:4px;'></div>";
strPopHtm += "</th></tr>";
strPopHtm += "<tr><td id='tdPopContent' colspan='2' align='center' valign='top'><div id='divPopContent' style='line-height:18px;'></div><iframe scrolling='auto' style='border:0px; width:100%;height:100%' frameborder='0' id='frmPopCenter'></iframe></td></tr>";
strPopHtm += "</table></div>";

document.writeln(strPopHtm);
var objPopDiv = new PopDiv();

var strFloatHtm = "<div id='divF' class='DivFloat' style='display:none;'><table border='0' cellspacing='0' cellpadding='0' id='tdFme' class='FTable FTW'><tr class='thc' id='trShine'>";
strFloatHtm += "<th id='thFloatTitle' height='28' align='left'><span id='spnFloatTitle'></span></th><th width='10%' id='thFloatCloseTitle'>";
strFloatHtm += "<div onclick='objFloatDiv.close()' class='close' style='float:right; margin-right:4px;' id='divFloatCloseImg'></div>";
strFloatHtm += "</th></tr>";
