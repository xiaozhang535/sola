...
<body>
    <form name="form1" method="post" action="Register.php" id="form1">
<div>
...
<!--导航栏结束-->
    <div class="divMain" style="margin-top: 30px;">
        <div class="divCon">
            <div class="divBan">
                <div class="header-text reg_cg">
                    <a href="../index.php" title="" class="head">首页</a><a href="Register.php#" title="" class="fBold">采购商注册</a></div>
            </div>
            <div class="divText">
                    <div style="background-color: #FFF; border: 3px solid #888;line-height: 20px; padding: 8px; margin-bottom:10px;margin-top:0px;width:97%">
                        <b style="color: green">温馨提示：</b>1. 此页面填写的登录帐号和密码是您公司管理员的账户<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 为了便于管理，登录后您可以在菜单“设置-员工管理”中添加员工帐号。
                    </div>
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnPwdMess" class="fGray">6-16个字符或数字组成，区分大小写</span> <span class="fRed" id="spnPwd"
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnEmailMess" class="fGray">发送安全数据 (找回密码) 时使用</span>
                        <span class="fRed" id="spnEmail" style="display: none;"></span></td>
                </tr>
                <tr>
	...
	<td></td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="hidRights" type="hidden" value="010005,010024,010023,010026,01002101,01002102,01002103,01002104,01002105,01002106,01002107,01002108,01002109,01002110,01002111,01002112,010002,010001,010003,01000401,01000402,01000403,01000404,01000405,01000406,01000407,01000408,01000409,01000410,01000411,01000412,04000205,04000203,040007,04000105,04000103,040006,010009,010027,010031,010013,010014,010007,010025,010028,010029,200201,20020503,20020504,20020505,200209,200204,010014,01001401,01001402,01001403,01001404,01001405,01001406,01001407,01001408,03001406,03001407" />
                    </td>
                    <td>
                    </td>
                </tr>
