...
<title>
	gogofly- 找回密码
</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="description" content="gogofly是中国领先的国际机票分销交易平台,提供优势政策、航线自主选择、在线预订、在线支付、快速出票，实现实时交易并提供专业的售前、售中、售后服务；为各类机票代理人提供国际机票采购、供应等一站式解决方案。" /><meta name="keywords" content="国际机票,gogofly,国际PNR导入,国际机票平台,国际机票预订" /><link href="css/style.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" language="javascript" src="../Prototype.js"></script>
    <script type="text/javascript" language="javascript" src="../Valid.js"></script>
    <script type="text/javascript" language="javascript" src="js/remember.js"></script>
</head>
<body>
    <form name="form1" method="post" action="Remember.php" id="form1" onsubmit="return Step(1)">
<div>
...
<!--导航栏结束-->
    <div class="divMain" style="margin-top: 30px;">
        <div class="divCon">
            <div class="divBan">
                <div class="header-text remeber">
                    <a href="../index.php" title="" class="head">首页</a><a href="Remember.php#" title="" class="fBold">找回密码</a></div>
            </div>
            <div class="divText">
                <div id="pnlStep1" class="mt">
...
<table width="90%" border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td height="40" colspan="2"><span class="f16 fBold">1.填写登录帐号</span></td>
    </tr>
  <tr>
    <td height="30" colspan="2" valign="bottom"><span class="fGray">请填写您要找回密码的登录帐号：</span></td>
    </tr>
  <tr>
    <td width="30%"><input id="txtAccount" type="text" class="inputReg" style="width:200px;" onfocus="txtFocus(this)"/></td>
    <td width="70%"><span class="fRed" id="spnAccount"></span></td>
  </tr>
  <tr>
    <td height="60" colspan="2"><input id="btnStep1" type="submit" value="下一步" class="inputBtn"/>
    </td>
    </tr>
  <tr>
